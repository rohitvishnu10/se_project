...
const Home = () => {
  const now = new Date();
  const time=  now.toLocaleString("en-IN", { timeZone: "Asia/Kolkata" ,hour:'2-digit',minute:'2-digit'}
   ...
   <section className='flex size-full flex-col gap-10 text-white'>
    ...
    bg-hero bg-cover'>
      ...
      max-md:px-5 max-md:py-8 lg:p-11'>
        ...
        rounded py-2 text-center text-base font-normal'>Upcoming Meetings</h2>
